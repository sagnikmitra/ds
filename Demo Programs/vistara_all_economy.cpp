...
int main(void)
{
    ...
    {
        cout << "Invalid Seat Row. Economoy Class Seats at VISTARA AIRBUS ALL ECONOMY are ranged from 1A to 12F & 14A to 29F. Thank You.\n";
        exit(1);
    }
    ...
    {
        cout << "Invalid Seat Position. Economoy Class Seats at VISTARA AIRBUS ALL ECONOMY are ranged from 1A to 12F & 14A to 29F. Thank You.\n"
             << endl;
        exit(1);
    }
