...
int main(void)
{
    ...
    cout << "Instructions for giving an input:" << endl
         ...
         << "--------------------------------------------------------------------------------------------------------" << endl
         << "Enter your Seat Row [The Numberic Digit(s) on the left of your seat no.]: ";
    cin >> s_row;
    ...
    if (s_row >= 1 && s_row <= 6)
    {
        cout << "\nYou're a Non-Economy Class Passenger, Q-Code Generation Process is for Economy Class Only." << endl
             << "Economoy Class Seats at VISTARA AIRBUS A320 are ranged from 7A to 12F & 14A to 29F. Thank You.\n";
        exit(1);
    }

    else if (s_row < 1 || s_row > 29 || s_row == 13)
    {
        cout << "Invalid Seat Row. Economoy Class Seats at VISTARA AIRBUS A320 are ranged from 7A to 12F & 14A to 29F. Thank You.\n";
        exit(1);
    }
    ...
    {
        cout << "Invalid Seat Position. Economoy Class Seats at VISTARA AIRBUS A320 are ranged from 7A to 12F & 14A to 29F. Thank You.\n"
             << endl;
        exit(1);
    }

    //UPPERCASE UPDATATION
    if (s_position == 'a')
        s_position = 'A';
    if (s_position == 'b')
        s_position = 'B';
